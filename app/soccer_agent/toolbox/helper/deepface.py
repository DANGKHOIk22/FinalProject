...
class DeepFaceRepresentation():
    def __init__(self,model_recognition_name: str = "VGG-Face",model_detector_name: str = "opencv"):
        self.model_recognition: FacialRecognition = modeling.build_model(
            task="facial_recognition", model_name=model_recognition_name
        )
        self.model_detector: Detector = modeling.build_model(
            task="face_detector", model_name=model_detector_name
        )
    ...
    def represent(self,
        ...
        for idx, single_img_path in enumerate(images):
            ...
            target_size = self.model_recognition.input_shape
        ...
        embeddings = self.model_recognition.forward(batch_images)
    ...
    def is_valid_landmark(self, coord: Optional[Union[tuple, list]], width: int, height: int) -> bool:
        """
    ...
    def extract_faces(self,
        ...
        for face_obj in face_objs:
            ...
            for key, value in landmarks.items():
                if not self.is_valid_landmark(value, width, height):
                    landmarks[key] = None
    ...
    def detect_faces(self,
        ...
        facial_areas = self.model_detector.detect_faces(img)
