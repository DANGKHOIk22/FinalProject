...
def get_entity_extraction_prompt_template() -> ChatPromptTemplate:
    """Create a prompt template for extracting soccer-related entities from user queries.It is used in the 'textual_entity_search' tool."""

    extract_entity_prompt_template = ChatPromptTemplate.from_messages([
        SystemMessage(
    ...
    return extract_entity_prompt_template