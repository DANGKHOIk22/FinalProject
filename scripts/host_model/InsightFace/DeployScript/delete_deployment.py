"""
Delete InsightFace Deployment from Azure Machine Learning
...
Usage:
    ...
    python delete_deployment.py --endpoint-name insightface-endpoint \\
...
class AzureMLInsightFaceDelete:
    """Handles deletion of InsightFace deployment from Azure ML."""
    ...
    def cleanup(self, delete_endpoint: bool = True) -> None:
        ...
        """
        logger.info("=" * 60)
        logger.info("Starting InsightFace Deployment Cleanup")
        logger.info("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Delete InsightFace deployment from Azure Machine Learning",
...
Examples:
  ...
  python delete_deployment.py --keep-endpoint
    ...
    parser.add_argument(
        "--endpoint-name",
        default=None,
        help=f"Azure ML endpoint name (default: {AzureMLInsightFaceDelete.DEFAULT_ENDPOINT_NAME})"
    )
    parser.add_argument(
        "--deployment-name",
        default=None,
        help=f"Deployment name to delete (default: {AzureMLInsightFaceDelete.DEFAULT_DEPLOYMENT_NAME})"
    )
    parser.add_argument(
        "--force",
        action="store_true",
    ...
    try:
        ...
        deleter = AzureMLInsightFaceDelete(
